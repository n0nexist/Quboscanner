...
public class MinecraftServer {
  ...
  public static String getRandIP() {
    ...
    sb.append(rand.nextInt(256)).append(".");
    sb.append(rand.nextInt(256)).append(".");
    sb.append(rand.nextInt(256)).append(".");
