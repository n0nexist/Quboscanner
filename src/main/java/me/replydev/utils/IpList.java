...
public class IpList {
    ...
    public IpList(String _start,String _end){
        if(isNotIp(_start)) throw new IllegalArgumentException(_start + " is not a valid starting ip!");
        if(isNotIp(_end)) throw new IllegalArgumentException(_end + " is not a valid ending ip!");
